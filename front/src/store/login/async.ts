...
export const loginUserAsync = createAsync<
  LoginRequest,
  LoginResponse | null,
  CustomError
>('loginUser', async (params, dispatch) => {
  ...
  if (
    params == null ||
    StringUtil.isEmpty(params.username) ||
    StringUtil.isEmpty(params.password)
  ) {
...
export type loginUserAsyncType = (
  req: LoginRequest
